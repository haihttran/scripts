...
num_threads=24
v_path=/home/ubuntu/data/s3/04nov2022/1fps
...
parallel -j $num_threads "mkdir ${s_path}/{};ffmpeg -i ${v_path}/{}.mp4 -ss 5 -vf select='gte(n\, 0),fps=1' ${s_path}/{}/'image_%06d.jpg'" ::: `ls ${v_path} |cut -d. -f1`
