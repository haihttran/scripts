...
def main():
	frames_path = '/media/ubuntu/ubuntu_storage/goats/frames'
	annotations_path = '/media/ubuntu/ubuntu_storage/goats/json'
	images_path = '/media/ubuntu/ubuntu_storage/goats/images_raw'
	labels_path = '/media/ubuntu/ubuntu_storage/goats/labels_raw'
	is_path(images_path)
	is_path(labels_path)
	...
	for video in sorted(os.listdir(frames_path)):
		...
		if len(objects) > 0:
			...
			# categories = ['head','cow']
			categories = ['goat_head','goat_body']
