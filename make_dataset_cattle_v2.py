...
def main():
	frames_path = '/media/ubuntu/ubuntu_storage/Woodonga/goat/frames'
	annotations_path = '/media/ubuntu/ubuntu_storage/Woodonga/goat/annotation'
	images_path = '/media/ubuntu/ubuntu_storage/Woodonga/goat/images_raw'
	labels_path = '/media/ubuntu/ubuntu_storage/Woodonga/goat/labels_raw'
	is_path(images_path)
	is_path(labels_path)
	...
	for video in sorted(os.listdir(frames_path)):
		...
		if len(objects) > 0:
			...
			categories = ['sheep_head','sheep_body','dog_head','dog_body','person_head','person_body']
